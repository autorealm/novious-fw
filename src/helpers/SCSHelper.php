...
class SCSHelper {
	...
	private $config = array (
		...
		'bucket' => '',
		'path'  => '/assets/cache/',
		'access_key' => 'v2a2ctPF8hBSwXSEauRc',
		'secret_key' => 'e06342b96a411883ab044bd5b36a709022e19432'
		);

	public function __construct() {
		$this->handler = new Storage();
	}
	...
	public function put($key, $value, $type=self::STORAGE_TYPE_MIXED) {
	...
	public function with($bucket) {
		...
		if ($ret) $this->config['bucket'] = $bucket;
